...
export function WhyGeoWellSection() {
  return (
...
export function InsuranceCalloutSection() {
  return (
...
export function ClientsSaySection() {
  return (
    <section className="clients-say section" aria-labelledby="clients-say-heading">
      <div className="container">
        <motion.header
...
export function IndustrySpecialistsSection() {
  return (
    ...
    <section className="service-areas section" aria-labelledby="areas-heading">
      <div className="container">
        ...
        <p className="areas-note">
          Don&rsquo;t see your city? Call us. If it&rsquo;s in Central Florida, we&rsquo;re already on our way.
        </p>
      </div>
    </section>
  )
